...
CREATE TABLE IF NOT EXISTS accounts (
  ...
  owner_employee_id BIGINT       NOT NULL COMMENT '负责该账号的员工ID（原employee_id改名）',
...
CREATE TABLE IF NOT EXISTS posts (
  ...
  content           TEXT          NULL     COMMENT '文案（原copywriting改名）',
  cover_url         VARCHAR(500)  NULL     COMMENT '封面图URL（原cover_image_url改名）',
  ...
  publish_time      DATETIME      NOT NULL COMMENT '发布时间（原published_at DATE改名并改为DATETIME）',
