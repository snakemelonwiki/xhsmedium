...
graph TB
    subgraph 客户端四端口
        OP[运营端 staff<br/>3000 / Next 3002]
        SA[销售端 sales<br/>3000 / Next 3002]
        AC[教务端 academic<br/>3000 / Next 3002]
        SU[主管端 admin<br/>3000 / Next 3002]
...
| 3000 统一登录 | sales / academic / staff / admin / supervisor | http://localhost:3003 (3002 被 Next 占) | 见下 |
| 3002 新前端 | 同上 | http://localhost:3002 | 同上（Next.js 版） |
