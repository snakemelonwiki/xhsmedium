  ...
  return (
    <Space direction="vertical" size={16} className="page-stack">
      ...
      <div className="metric-grid">
        ...
        <Card><Statistic title="客资数" value={summary?.todayLeads ?? 0} prefix={<UserSwitchOutlined />} /></Card>
        <Card><Statistic title="点赞数" value={likeCount} prefix={<LineChartOutlined />} /></Card>
        <Card><Statistic title="有效账号数" value={summary?.updatedAccounts ?? 0} prefix={<IdcardOutlined />} /></Card>
